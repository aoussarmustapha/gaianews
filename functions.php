<?php
  ...
  $listaCategorie = array("ambiente", "attualita", "cultura-e-societa", "green-economy", "salute", "scienza-e-tecnologia");
	...
	function add_custom_class( $classes = array(), $menu_item = false ) {
		//panta rei
		if ( is_single() && in_category( 'panta-rei' ) && 46611 == $menu_item->ID && ! in_array( 'current-menu-item', $classes ) ) {
			$classes[] = 'current-menu-item';
		}
		if ( is_single() && in_category( 'panta-rei' ) && 25618 == $menu_item->ID && ! in_array( 'current-post-ancestor', $classes ) ) {
			$classes[] = 'current-post-ancestor';
		}
		if ( is_single() && in_category( 'panta-rei' ) && 25618 == $menu_item->ID && ! in_array( 'current-menu-parent', $classes ) ) {
			$classes[] = 'current-menu-parent';
		}

		if ( is_single() && in_category( 'micromacro' ) && 46610 == $menu_item->ID && ! in_array( 'current-menu-item', $classes ) ) {
			$classes[] = 'current-menu-item';
		}
		if ( is_single() && in_category( 'micromacro' ) && 25618 == $menu_item->ID && ! in_array( 'current-post-ancestor', $classes ) ) {
			$classes[] = 'current-post-ancestor';
		}
		if ( is_single() && in_category( 'micromacro' ) && 25618 == $menu_item->ID && ! in_array( 'current-menu-parent', $classes ) ) {
			$classes[] = 'current-menu-parent';
		}

		if ( is_single() && in_category( 'parchi-e-aree-protette-2' ) && 46612 == $menu_item->ID && ! in_array( 'current-menu-item', $classes ) ) {
			$classes[] = 'current-menu-item';
		}
		if ( is_single() && in_category( 'parchi-e-aree-protette-2' ) && 25618 == $menu_item->ID && ! in_array( 'current-post-ancestor', $classes ) ) {
			$classes[] = 'current-post-ancestor';
		}
		if ( is_single() && in_category( 'parchi-e-aree-protette-2' ) && 25618 == $menu_item->ID && ! in_array( 'current-menu-parent', $classes ) ) {
			$classes[] = 'current-menu-parent';
		}
